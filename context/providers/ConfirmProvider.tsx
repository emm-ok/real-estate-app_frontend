            ...
            >
              ...
              <div className="flex justify-end gap-3 font-medium">
                <button
                  onClick={close}
                  disabled={loading}
                  className="px-4 py-2 rounded text-md border disabled:opacity-50"
                >
                ...
                <button
                  ...
                  disabled:opacity-70 ${variantStyles(options.variant)}`}
                >
                  {loading && (
...
function VariantIcon({ variant }: { variant?: ConfirmVariant }) {
  ...
  switch (variant) {
    case "danger":
      return <Trash className={`${base} text-red-600`} />;
    case "warning":
      return <AlertTriangle className={`${base} text-red-600`} />;
    case "success":
